...
export const roadmapItems: RoadmapItem[] = [
  ...
  // ── PLANNED ───────────────────────────────────────────────────────────────
  {
    ...
    doneCriteria: [
      ...
      "STL export verified with non-empty artifact assertion",
      "STEP export support added for the Python BREP family",
    ],
  },
  {
    ...
    doneCriteria: [
      ...
      "Experimental STL export is verified with non-empty output",
      "At least one additional mesh export format (glTF or OBJ) is implemented",
