      ...
      <div className="mx-auto max-w-5xl">
        <header className="mb-14">
          ...
          <p className="max-w-3xl text-lg leading-relaxed text-gray-400">
            This page is the source of truth for roadmap state. Each item
            includes a target owner and explicit done criteria.
          </p>
          <div className="mt-6 flex flex-wrap gap-4 text-sm">
            <a
              href="https://github.com/el-j/omni-cad/issues"
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-lg border border-white/20 bg-white/5 px-4 py-2 font-semibold text-blue-300 hover:bg-white/10"
            >
              Linked Issues
            </a>
            <a
              href="https://github.com/el-j/omni-cad/milestones"
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-lg border border-white/20 bg-white/5 px-4 py-2 font-semibold text-blue-300 hover:bg-white/10"
            >
          ...
          {roadmapItems.map((item) => (
            ...
            >
              <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
                ...
                <span
                  className={`rounded-full border px-3 py-1 text-xs font-bold uppercase tracking-wider ${statusClasses[item.status]}`}
                >
                  {item.status.replace("-", " ")}
                </span>
              </div>
